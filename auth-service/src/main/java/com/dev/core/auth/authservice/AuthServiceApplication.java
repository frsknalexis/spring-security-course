package com.dev.core.auth.authservice;
...
public class AuthServiceApplication {
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
			...
			userService.saveUser(new User(null, "John Travolta", "john", "1234",
					Collections.emptyList()));
			userService.saveUser(new User(null, "Will Smith", "will", "1234",
					Collections.emptyList()));
			userService.saveUser(new User(null, "Jim Carry", "jim", "1234",
					Collections.emptyList()));
